...
function Home() {
    ...
    const LinkCard = ({ to, bgImage, title, description }) => (
        <Link to={to} className='h-[15rem] w-full'>
            <motion.div
    ...
    return (
        <div className="flex flex-col gap-4 bg-black p-2 sm:p-4">
            ...
            <motion.h3
                className="text-center text-2xl sm:text-3xl lg:text-5xl my-4 text-white"
            ...
            >
                <motion.span
                    className="font-bold bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text animate-gradient-animate text-transparent text-2xl sm:text-4xl lg:text-5xl"
            ...
            <div className="mx-auto grid w-full max-w-6xl grid-cols-1 gap-6 py-8 sm:grid-cols-2 sm:py-12 lg:grid-cols-3">
